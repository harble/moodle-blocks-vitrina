...
$string['splitbycategories'] = 'Dividir por categorías';
$string['splitbycategories_help'] = 'Muestra una sección por cada categoría de curso seleccionada en el bloque. La página de catálogo sigue siendo una lista única.';
...
$string['coursetype_code_title'] = 'Código del curso: {$a}';
