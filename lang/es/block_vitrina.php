...
$string['splitbycategories'] = 'Dividir bloque por categorías';
$string['splitbycategories_help'] = 'Si se habilita, la vista del bloque mostrará una sección independiente por cada categoría de curso seleccionada (cada una con sus propias pestañas y botón de ver más). La página de catálogo seguirá siendo una sola lista unificada.';
...
$string['coursetagsfilter'] = 'Etiquetas de curso';
...
$string['defaultsort'] = 'Todos los cursos';
...
$string['greats'] = 'Cursos mejor valorados';
...
$string['recents'] = 'Próximos cursos';
...
$string['settingsheaderltering'] = 'Filtros';
...
$string['tabtitle_greats'] = 'Cursos mejor valorados';
...
$string['coursetype_tags_title'] = 'Etiquetas del curso: {$a}';
