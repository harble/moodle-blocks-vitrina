...
$string['splitbycategories'] = 'Split block by categories';
$string['splitbycategories_help'] = 'When enabled, the block view renders one independent section per selected course category (each with its own tabs and load more button). The catalog page remains a single unified list.';
